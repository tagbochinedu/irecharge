...
import { editHotels } from "../Features/Hotels/HotelSlice";
    ...
    <section className="text-white mb-10 max-w-[350px] md:max-w-xl mx-auto pt-5">
      ...
      >
        ...
        <input
          ...
          value={name}
          required
          className="mb-5 h-7 md:h-10 rounded-md text-logo px-2 w-full outline-0 bg-lgr border-[1px] focus:border-logo"
          onChange={(e) => {
